...
class User extends Banco
{
	...
	{
		$sql = mysql_query("SELECT email from socios WHERE email = '$email'");
		$no_rows = mysql_num_rows($sql);
	...
	public function getMailing(){
		$data = $this->pdo->query("SELECT email FROM socios");
        return $data;
	}
	...
	public function check_login_admin($emailusuario, $senha){
		...
		$result = mysql_query("SELECT id, nome, email, senha, id_nivel from socios WHERE 
